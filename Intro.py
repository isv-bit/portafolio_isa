...
apps = [
    ...
    {"titulo":"GENERADOR DE TEXTO","desc":"Aplicación de inteligencia artificial que genera texto automáticamente usando redes neuronales LSTM.","img":get_base64("robot.jpg"),"url":"https://generadortext-isa.streamlit.app/","color":"violet"},
